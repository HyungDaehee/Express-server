...
app.use(cors({
  origin: ['https://restaurant-search-mu.vercel.app','https://restaurant-search-git-master-hyungs-projects-40d7cee3.vercel.app'],
  methods: ['GET', 'POST'],
}));
...
app.get("/auth/Kakao", async (req, res) => {
  ...
  let REDIRECT_URI = 'https://restaurant-search-git-master-hyungs-projects-40d7cee3.vercel.app/Login';
